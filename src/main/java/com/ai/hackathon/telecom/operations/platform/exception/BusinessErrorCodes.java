...
public enum BusinessErrorCodes {
    ...
    INSUFFICIENT_PRIVILEGE(312, FORBIDDEN, "You do not have sufficient privileges to perform this operation"),
    EMAIL_ALREADY_EXISTS(313, CONFLICT, "A user with this email already exists"),
    ;
